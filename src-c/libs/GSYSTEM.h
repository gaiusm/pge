/* automatically created by mc from /home/gaius/GM2/graft-5.2.0/gcc-5.2.0/gcc/gm2/gm2-libs-iso/SYSTEM.def.  */
...
#   define SYSTEM_BITSPERLOC 8
#   define SYSTEM_LOCSPERWORD 4
#   define SYSTEM_LOCSPERBYTE (8 / SYSTEM_BITSPERLOC)
