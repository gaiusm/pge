...
static void InvokeHandler (void)
{
  ...
  if (h == NULL)
    {
      libc_printf ((char *) "runtime exception called invoking gdb\\n", 39);
      gdbif_sleepSpin ();
...
static void indexf (void * a)
{
  RTExceptions_Raise ( ((unsigned int) (M2EXCEPTION_indexException)), "../git-pge/m2/RTExceptions.mod", 610, 9, "indexf", "array index out of bounds");
}
...
static void range (void * a)
{
  RTExceptions_Raise ( ((unsigned int) (M2EXCEPTION_rangeException)), "../git-pge/m2/RTExceptions.mod", 622, 9, "range", "assignment out of range");
}
...
static void casef (void * a)
{
  RTExceptions_Raise ( ((unsigned int) (M2EXCEPTION_caseSelectException)), "../git-pge/m2/RTExceptions.mod", 634, 9, "casef", "case selector out of range");
}
...
static void invalidloc (void * a)
{
  RTExceptions_Raise ( ((unsigned int) (M2EXCEPTION_invalidLocation)), "../git-pge/m2/RTExceptions.mod", 646, 9, "invalidloc", "invalid address referenced");
}
...
static void function (void * a)
{
  RTExceptions_Raise ( ((unsigned int) (M2EXCEPTION_functionException)), "../git-pge/m2/RTExceptions.mod", 658, 9, "function", "... function ... ");  /* --fixme-- what has happened ?  */
}
...
static void wholevalue (void * a)
{
  RTExceptions_Raise ( ((unsigned int) (M2EXCEPTION_wholeValueException)), "../git-pge/m2/RTExceptions.mod", 670, 9, "wholevalue", "illegal whole value exception");
}
...
static void wholediv (void * a)
{
  RTExceptions_Raise ( ((unsigned int) (M2EXCEPTION_wholeDivException)), "../git-pge/m2/RTExceptions.mod", 682, 9, "wholediv", "illegal whole value exception");
}
...
static void realvalue (void * a)
{
  RTExceptions_Raise ( ((unsigned int) (M2EXCEPTION_realValueException)), "../git-pge/m2/RTExceptions.mod", 694, 9, "realvalue", "illegal real value exception");
}
...
static void realdiv (void * a)
{
  RTExceptions_Raise ( ((unsigned int) (M2EXCEPTION_realDivException)), "../git-pge/m2/RTExceptions.mod", 706, 9, "realdiv", "real number division by zero exception");
}
...
static void complexvalue (void * a)
{
  RTExceptions_Raise ( ((unsigned int) (M2EXCEPTION_complexValueException)), "../git-pge/m2/RTExceptions.mod", 718, 9, "complexvalue", "illegal complex value exception");
}
...
static void complexdiv (void * a)
{
  RTExceptions_Raise ( ((unsigned int) (M2EXCEPTION_complexDivException)), "../git-pge/m2/RTExceptions.mod", 730, 9, "complexdiv", "complex number division by zero exception");
}
...
static void protection (void * a)
{
  RTExceptions_Raise ( ((unsigned int) (M2EXCEPTION_protException)), "../git-pge/m2/RTExceptions.mod", 742, 9, "protection", "protection exception");
}
...
static void systemf (void * a)
{
  RTExceptions_Raise ( ((unsigned int) (M2EXCEPTION_sysException)), "../git-pge/m2/RTExceptions.mod", 754, 9, "systemf", "system exception");
}
...
static void coroutine (void * a)
{
  RTExceptions_Raise ( ((unsigned int) (M2EXCEPTION_coException)), "../git-pge/m2/RTExceptions.mod", 766, 9, "coroutine", "coroutine exception");
}
...
static void exception (void * a)
{
  RTExceptions_Raise ( ((unsigned int) (M2EXCEPTION_exException)), "../git-pge/m2/RTExceptions.mod", 778, 9, "exception", "exception exception");
}
...
RTExceptions_EHBlock RTExceptions_GetBaseExceptionBlock (void)
{
  if (currentEHB == NULL)
    {
      M2RTS_Halt ((char *) "../git-pge/m2/RTExceptions.mod", 30, 596, (char *) "GetBaseExceptionBlock", 21, (char *) "currentEHB has not been initialized yet", 39);
    }
  else
    {
      return currentEHB;
    }
  ReturnException ("/home/gaius/GM2/graft-combine/gm2-floppsie/gcc/m2/gm2-libs/RTExceptions.def", 25, 1);
  __builtin_unreachable ();
}
