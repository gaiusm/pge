...
static void Init (void)
{
  ...
  macroHeap = GC_initGarbage ((GC_walkP) {(GC_walkP_t) markMacroEntity}, sizeof ((*m)), DynamicStrings_InitString ((char *) "macro", 5));
  objectHeap = GC_initGarbage ((GC_walkP) {(GC_walkP_t) markObjectEntity}, sizeof ((*o)), DynamicStrings_InitString ((char *) "objects", 7));
}
