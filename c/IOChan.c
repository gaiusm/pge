...
IOConsts_ReadResults IOChan_ReadResult (IOChan_ChanId cid)
{
  ...
  */
  ...
  ReturnException ("/home/gaius/GM2/graft-combine/gm2-floppsie/gcc/m2/gm2-libs-iso/IOChan.def", 10, 1);
  __builtin_unreachable ();
}
...
IOChan_ChanExceptions IOChan_ChanException (void)
{
  ...
  */
  if (IOChan_IsChanException ())
    ...
    {
      M2RTS_NoException ("/home/gaius/GM2/graft-combine/gm2-floppsie/gcc/m2/gm2-libs-iso/IOChan.mod", 513, 24, "ChanException", "not in the exceptional execution state");
    }
  ReturnException ("/home/gaius/GM2/graft-combine/gm2-floppsie/gcc/m2/gm2-libs-iso/IOChan.def", 10, 1);
  __builtin_unreachable ();
}
