/* automatically created by mc from /home/gaius/GM2/graft-5.4.0/gcc-5.4.0/gcc/gm2/gm2-libs-iso/IOChan.mod.  */
...
IOConsts_ReadResults IOChan_ReadResult (IOChan_ChanId cid)
{
  ...
  if (dtp == NULL)
    ...
    return dtp->result;
  ReturnException ("/home/gaius/GM2/graft-5.4.0/gcc-5.4.0/gcc/gm2/gm2-libs-iso/IOChan.def", 8, 1);
}
...
IOChan_ChanExceptions IOChan_ChanException (void)
{
  if (IOChan_IsChanException ())
    ...
    M2RTS_NoException ("/home/gaius/GM2/graft-5.4.0/gcc-5.4.0/gcc/gm2/gm2-libs-iso/IOChan.mod", 505, 24, "ChanException");
  ReturnException ("/home/gaius/GM2/graft-5.4.0/gcc-5.4.0/gcc/gm2/gm2-libs-iso/IOChan.def", 8, 1);
}
