          ...
          switch (v->type)
            {
              ...
              default:
                CaseException ("/home/gaius/GM2/graft-combine/gm2-floppsie/gcc/m2/gm2-libs/RTint.def", 25, 1);
                __builtin_unreachable ();
            }
          v = v->pending;
        }
...
void RTint_ReArmTimeVector (unsigned int vec, unsigned int micro, unsigned int secs)
{
  ...
  if (v == NULL)
    {
      M2RTS_Halt ((char *) "/home/gaius/GM2/graft-combine/gm2-floppsie/gcc/m2/gm2-libs/RTint.mod", 68, 276, (char *) "ReArmTimeVector", 15, (char *) "cannot find vector supplied", 27);
    }
  else
    {
...
void RTint_GetTimeVector (unsigned int vec, unsigned int *micro, unsigned int *secs)
{
  ...
  if (v == NULL)
    {
      M2RTS_Halt ((char *) "/home/gaius/GM2/graft-combine/gm2-floppsie/gcc/m2/gm2-libs/RTint.mod", 68, 302, (char *) "GetTimeVector", 13, (char *) "cannot find vector supplied", 27);
    }
  else
    {
...
void * RTint_AttachVector (unsigned int vec, void * p)
{
  ...
  if (v == NULL)
    {
      M2RTS_Halt ((char *) "/home/gaius/GM2/graft-combine/gm2-floppsie/gcc/m2/gm2-libs/RTint.mod", 68, 329, (char *) "AttachVector", 12, (char *) "cannot find vector supplied", 27);
    }
  else
    {
      l = v->arg;
  ...
  ReturnException ("/home/gaius/GM2/graft-combine/gm2-floppsie/gcc/m2/gm2-libs/RTint.def", 25, 1);
  __builtin_unreachable ();
}
  ...
  if (v == NULL)
    {
      ...
      if (v == NULL)
        {
          M2RTS_Halt ((char *) "/home/gaius/GM2/graft-combine/gm2-floppsie/gcc/m2/gm2-libs/RTint.mod", 68, 362, (char *) "IncludeVector", 13, (char *) "cannot find vector supplied", 27);
        }
      else
        {
...
void RTint_ExcludeVector (unsigned int vec)
{
  ...
  if (v == NULL)
    {
      M2RTS_Halt ((char *) "/home/gaius/GM2/graft-combine/gm2-floppsie/gcc/m2/gm2-libs/RTint.mod", 68, 405, (char *) "ExcludeVector", 13, (char *) "cannot find pending vector supplied", 35);
    }
  else
    {
  ...
  if (pri < (7))
    {
      ...
      if (((untilInterrupt && (i == NULL)) && (o == NULL)) && ! found)
        {
          M2RTS_Halt ((char *) "/home/gaius/GM2/graft-combine/gm2-floppsie/gcc/m2/gm2-libs/RTint.mod", 68, 721, (char *) "Listen", 6, (char *) "deadlock found, no more processes to run and no interrupts active", 65);
        }
      /* printf('}
      ') ;  */
