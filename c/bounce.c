/* automatically created by mc from ../git-pge-frozen/m2/bounce.mod.  */
...
void _M2_bounce_init (__attribute__((unused)) int argc, __attribute__((unused)) char *argv[])
{
  popWorld_init (TRUE);
  ...
  */
  ...
  twoDsim_simulateFor (1.0);
  twoDsim_simulateFor (1.0);
  twoDsim_simulateFor (10.0);  /* 15.0 ok  */
}

void _M2_bounce_finish (__attribute__((unused)) int argc, __attribute__((unused)) char *argv[])
{
}
