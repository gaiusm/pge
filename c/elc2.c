/* automatically created by mc from ../git-pge-frozen/m2/elc2.mod.  */
...
static void placeNonFixed (void)
{
  ...
  m = macroObjects_rectangle (m, TRUE, Fractions_zero (), (deviceIf_Colour) deviceIf_yellow (), Fractions_initFract (0, 3, 100), Fractions_initFract (0, 3, 100));
  m = macroObjects_rootMacro (m);
...
void _M2_elc2_init (__attribute__((unused)) int argc, __attribute__((unused)) char *argv[])
{
...
void _M2_elc2_finish (__attribute__((unused)) int argc, __attribute__((unused)) char *argv[])
{
}
