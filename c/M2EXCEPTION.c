...
M2EXCEPTION_M2Exceptions M2EXCEPTION_M2Exception (void)
{
  ...
  */
  if (M2EXCEPTION_IsM2Exception ())
    ...
    {
      RTExceptions_Raise ( ((unsigned int) (M2EXCEPTION_exException)), "/home/gaius/GM2/graft-combine/gm2-floppsie/gcc/m2/gm2-libs-iso/M2EXCEPTION.mod", 44, 25, "M2Exception", "current coroutine is not in the exceptional execution state");
    }
  ReturnException ("/home/gaius/GM2/graft-combine/gm2-floppsie/gcc/m2/gm2-libs-iso/M2EXCEPTION.def", 10, 1);
