/* do not edit automatically generated by mc from RTgen.  */
...
int libc_atexit (PROC proc);
void * libc_ttyname (int filedes);
unsigned int libc_sleep (unsigned int seconds);
int RTco_init (void);
int RTco_initThread (PROC p, unsigned int stackSize, unsigned int interruptLevel);
int RTco_initSemaphore (unsigned int value);
void RTco_wait (int semaphore);
void RTco_signal (int semaphore);
void RTco_transfer (int *p1, int p2);
void RTco_waitThread (int tid);
void RTco_signalThread (int tid);
int RTco_currentThread (void);
unsigned int RTco_currentInterruptLevel (void);
unsigned int RTco_turnInterrupts (unsigned int newLevel);
int RTco_select (int p1, void * p2, void * p3, void * p4, void * p5);
