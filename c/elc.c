/* automatically created by mc from ../git-pge-frozen/m2/elc.mod.  */
...
void _M2_elc_init (__attribute__((unused)) int argc, __attribute__((unused)) char *argv[])
{
...
void _M2_elc_finish (__attribute__((unused)) int argc, __attribute__((unused)) char *argv[])
{
}
