/* do not edit automatically generated by mc from deviceGroff.  */
...
void deviceGroff_Init (void)
{
  ...
  configHeap = GC_initGarbage ((GC_walkP) {(GC_walkP_t) markConfig}, sizeof ((*config)), DynamicStrings_InitString ((char *) "config", 6));
