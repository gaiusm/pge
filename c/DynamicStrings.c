  ...
  if (o < h)
    {
      ...
      AddDebugInfo ((*c).next);
      (*c).next = AssignDebug ((*c).next, (char *) "/home/gaius/GM2/graft-combine/gm2-floppsie/gcc/m2/gm2-libs/DynamicStrings.mod", 77, 722, (char *) "ConcatContents", 14);
    }
  else
    {
      (*c).len = i;
  ...
  if (j < h)
    {
      ...
      if (TraceOn)
        {
          (*c).next = AssignDebug ((*c).next, (char *) "/home/gaius/GM2/graft-combine/gm2-floppsie/gcc/m2/gm2-libs/DynamicStrings.mod", 77, 917, (char *) "ConcatContentsAddress", 21);
        }
    }
  else
    {
...
DynamicStrings_String DynamicStrings_InitString (char *a_, unsigned int _a_high)
{
  ...
  if (TraceOn)
    {
      s = AssignDebug (s, (char *) "/home/gaius/GM2/graft-combine/gm2-floppsie/gcc/m2/gm2-libs/DynamicStrings.mod", 77, 758, (char *) "InitString", 10);
    }
  return s;
  /* static analysis guarentees a RETURN statement will be used before here.  */
  __builtin_unreachable ();
...
DynamicStrings_String DynamicStrings_InitStringCharStar (void * a)
{
  ...
  if (TraceOn)
    {
      s = AssignDebug (s, (char *) "/home/gaius/GM2/graft-combine/gm2-floppsie/gcc/m2/gm2-libs/DynamicStrings.mod", 77, 957, (char *) "InitStringCharStar", 18);
    }
  return s;
  /* static analysis guarentees a RETURN statement will be used before here.  */
  __builtin_unreachable ();
...
DynamicStrings_String DynamicStrings_InitStringChar (char ch)
{
  ...
  if (TraceOn)
    {
      s = AssignDebug (s, (char *) "/home/gaius/GM2/graft-combine/gm2-floppsie/gcc/m2/gm2-libs/DynamicStrings.mod", 77, 977, (char *) "InitStringChar", 14);
    }
  return s;
  /* static analysis guarentees a RETURN statement will be used before here.  */
  __builtin_unreachable ();
...
DynamicStrings_String DynamicStrings_Dup (DynamicStrings_String s)
{
  ...
  if (TraceOn)
    {
      s = AssignDebug (s, (char *) "/home/gaius/GM2/graft-combine/gm2-floppsie/gcc/m2/gm2-libs/DynamicStrings.mod", 77, 1173, (char *) "Dup", 3);
    }
  return s;
  /* static analysis guarentees a RETURN statement will be used before here.  */
  __builtin_unreachable ();
...
DynamicStrings_String DynamicStrings_Add (DynamicStrings_String a, DynamicStrings_String b)
{
  ...
  if (TraceOn)
    {
      a = AssignDebug (a, (char *) "/home/gaius/GM2/graft-combine/gm2-floppsie/gcc/m2/gm2-libs/DynamicStrings.mod", 77, 1193, (char *) "Add", 3);
    }
  return a;
  /* static analysis guarentees a RETURN statement will be used before here.  */
  __builtin_unreachable ();
...
unsigned int DynamicStrings_EqualCharStar (DynamicStrings_String s, void * a)
{
  ...
  if (TraceOn)
    {
      t = AssignDebug (t, (char *) "/home/gaius/GM2/graft-combine/gm2-floppsie/gcc/m2/gm2-libs/DynamicStrings.mod", 77, 1258, (char *) "EqualCharStar", 13);
    }
  t = AddToGarbage (t, s);
...
unsigned int DynamicStrings_EqualArray (DynamicStrings_String s, char *a_, unsigned int _a_high)
{
  ...
  if (TraceOn)
    {
      t = AssignDebug (t, (char *) "/home/gaius/GM2/graft-combine/gm2-floppsie/gcc/m2/gm2-libs/DynamicStrings.mod", 77, 1288, (char *) "EqualArray", 10);
    }
  t = AddToGarbage (t, s);
  if (DynamicStrings_Equal (t, s))
    {
...
DynamicStrings_String DynamicStrings_Mult (DynamicStrings_String s, unsigned int n)
{
  ...
  if (TraceOn)
    {
      s = AssignDebug (s, (char *) "/home/gaius/GM2/graft-combine/gm2-floppsie/gcc/m2/gm2-libs/DynamicStrings.mod", 77, 1320, (char *) "Mult", 4);
    }
  return s;
  /* static analysis guarentees a RETURN statement will be used before here.  */
  __builtin_unreachable ();
...
DynamicStrings_String DynamicStrings_Slice (DynamicStrings_String s, int low, int high)
{
                  ...
                  if (t->contents.next == NULL)
                    {
                      ...
                      if (TraceOn)
                        {
                          t->contents.next = AssignDebug (t->contents.next, (char *) "/home/gaius/GM2/graft-combine/gm2-floppsie/gcc/m2/gm2-libs/DynamicStrings.mod", 77, 1388, (char *) "Slice", 5);
                        }
                    }
                  t = t->contents.next;
                }
  ...
  if (TraceOn)
    {
      d = AssignDebug (d, (char *) "/home/gaius/GM2/graft-combine/gm2-floppsie/gcc/m2/gm2-libs/DynamicStrings.mod", 77, 1405, (char *) "Slice", 5);
    }
  return d;
  /* static analysis guarentees a RETURN statement will be used before here.  */
  __builtin_unreachable ();
...
DynamicStrings_String DynamicStrings_RemoveComment (DynamicStrings_String s, char comment)
{
  ...
  if (TraceOn)
    {
      s = AssignDebug (s, (char *) "/home/gaius/GM2/graft-combine/gm2-floppsie/gcc/m2/gm2-libs/DynamicStrings.mod", 77, 1517, (char *) "RemoveComment", 13);
    }
  return s;
  /* static analysis guarentees a RETURN statement will be used before here.  */
  __builtin_unreachable ();
...
DynamicStrings_String DynamicStrings_RemoveWhitePrefix (DynamicStrings_String s)
{
  ...
  if (TraceOn)
    {
      s = AssignDebug (s, (char *) "/home/gaius/GM2/graft-combine/gm2-floppsie/gcc/m2/gm2-libs/DynamicStrings.mod", 77, 1629, (char *) "RemoveWhitePrefix", 17);
    }
  return s;
  /* static analysis guarentees a RETURN statement will be used before here.  */
  __builtin_unreachable ();
...
DynamicStrings_String DynamicStrings_RemoveWhitePostfix (DynamicStrings_String s)
{
  ...
  if (TraceOn)
    {
      s = AssignDebug (s, (char *) "/home/gaius/GM2/graft-combine/gm2-floppsie/gcc/m2/gm2-libs/DynamicStrings.mod", 77, 1651, (char *) "RemoveWhitePostfix", 18);
    }
  return s;
  /* static analysis guarentees a RETURN statement will be used before here.  */
  __builtin_unreachable ();
      ...
      if (frameHead == NULL)
        {
          ...
          M2RTS_Halt ((char *) "/home/gaius/GM2/graft-combine/gm2-floppsie/gcc/m2/gm2-libs/DynamicStrings.mod", 77, 176, (char *) "PopAllocationExemption", 22, (char *) "mismatched number of PopAllocation's compared to PushAllocation's", 65);
        }
      else
        {
