...
static hList initS (hList n, double time_, unsigned int id, history_springPoint w);

/*
   initC - fill in the fields of, n, and return n.
*/

static hList initC (hList n, double time_, unsigned int id1, unsigned int id2, history_whereHit w1, history_whereHit w2, coord_Coord cp);
...
static void updateTime (double time_);
...
static void updateTime (double time_)
{
  ...
  if (! (roots_nearSame (time_, currentTime)))
    {
